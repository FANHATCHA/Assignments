...
public class QuestController {
  ...
  public QuestController ( Player player ) {
    ...
    this.player = player;
    this.view = new View();
    this.headerView = new HeaderView(view, "QUEST: ");
    this.announcementView = new AnnouncementView(view);
    
    // Initially only quest zero is visitable
    if (questNameMapping.containsKey(0))
      visitableQuests.add(0);

    // quest 6 is the new added quest for milestone 4
    if (questNameMapping.containsKey(6))
      visitableQuests.add(6);
