...
The maximum number of pieces of a circle that can be made with a given number of straight cuts. For example, three cuts across a circle will produce six pieces if the cuts all meet at a common point, but seven if they do not.
